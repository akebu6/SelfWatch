          ...
          <Form.Group className="new-item">
            ...
            {["radio"].map((type) => (
              <div key={`your activity`} className="mb-3">
                <Form.Check
                  type={type}
                  onChange={this.handleActivityDataChanged.bind(this, "repeat")}
                  id={`repeat`}
                  label={`One Time or Repeat?`}
                ...
                <Form.Check
                  ...
                  onChange={this.handleActivityDataChanged.bind(this, "pause")}
                />
                <Form.Check
                  type={type}
                  id={`your activity`}
                  ...
                  onChange={this.handleActivityDataChanged.bind(this, "delete")}
                />
              </div>
            ))}
          </Form.Group>
